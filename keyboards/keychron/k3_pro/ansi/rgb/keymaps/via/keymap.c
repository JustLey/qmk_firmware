...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [CT_QUOT] = ACTION_TAP_DANCE_TAP_HOLD(KC_QUOT, KC_DQUO),
    [CT_DOT] = ACTION_TAP_DANCE_TAP_HOLD(KC_DOT, KC_GT),
    [CT_COMM] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMM, KC_LT),
...
[WIN_BASE] = LAYOUT_ansi_84(
     ...
     KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
     KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
     KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     TD(CT_CLN),  TD(CT_QUOT),            KC_ENT,             KC_HOME,
     SC_LSPO,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     TD(CT_COMM),  TD(CT_DOT),   TD(CT_SLSH),            SC_RSPC,  KC_UP,    KC_END,
